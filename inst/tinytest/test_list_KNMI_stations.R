...
expect_equal(nrow(list_stations()), 47,
             info = "test number of active stations with temperature sensor.")
# inactive and with temperature sensor
expect_equal(nrow(list_stations(active = FALSE)), 3,
             info = "test number of inactive stations with temperature sensor.")
...
expect_equal(ncol(list_stations()), 8,
             info = "test number of fields for the active stations with temperature sensor.")
