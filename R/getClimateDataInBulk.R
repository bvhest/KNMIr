...
#' better suited to retrieve data for very specific date-ranges.
#'
...
#'
#' @param station ID for the KNMI station. The available stations can be retrieved with the function 'listStations()'. Defaults to "ALL". . Note: a string of characters in the format 'iii'.
...
get_climate_data_in_bulk <- function(station = "ALL",
   ...
   if(station=='ALL' & fromYear < thisYear) {
      ...
      data <- retrieveDataRange(station, from, to)
   } else {
