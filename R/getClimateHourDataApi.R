...
#' and/or date-range.
#'
#' See the documentation of the function \code{\link{get_climate_data_api}}, as both functions work similarly.
#'
...
#' @export
get_climate_hour_data_api <- function(stationID = "ALL",
   ...
   colnames(data) <- c("STN","YYYYMMDD","HH","DDVEC","FHVEC","FG","FHX","FHXH","FHN","FHNH","FXX","FXXH","TG","TN","TNH","TX","TXH","T10N","T10NH","SQ","SP","Q","DR","RH","RHX","RHXH","EV24","PG","PX","PXH","PN","PNH","VVN","VVNH","VVX","VVXH","NG","UG","UX","UXH","UN","UNH")
