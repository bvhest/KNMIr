...
retrieveHistoricDEDataByStation <- function(stationID,
   ...
   pattern <- paste0("tageswerte_",str_pad(stationID, 5, pad = "0"))
   zipname <- filenames[grepl("00044", filenames)]
   ...
   filename <- paste0("produkt_klima_Tageswerte_",datum_van_tot,"_",str_pad(stationID, 5, pad = "0"),".txt")
   t <- unz(temp, filename)
