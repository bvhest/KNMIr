...
#' and the day-of-the-year that this value occured in the second range with daily values.
#' The function expects more or less continuously increasing values, for example the Huglin-index, VE-index, the yearly totalized amount of rain, etc.
#'
#' In summary:
...
#' @param dataframe containing the day-of-the-year and a column containing the value (note: The values must belong to the same year. The column-names are not relevant.)
#' @param dataframe containing the day-of-the-year and a column containing the value (note: The values must belong to the same year. The column-names are not relevant)
